...
- [ ] 운동 시간 선택 UI (60/90/120분) - PainCheckModal에 없음, 향후 추가 예정
- [x] 진행 상태 표시 (프로그레스 바) - PainCheckModal에 Step 1-3 진행 표시 구현 완료
...
- [ ] 네이버맵 지도 컴포넌트 연동 (향후 구현 예정)
- [ ] 지도 핀 표시 로직 (향후 구현 예정)
- [x] 헬스장 리스트 UI (GymCard 컴포넌트로 구현 완료)
- [ ] 지도/리스트 토글 기능 (향후 구현 예정)
