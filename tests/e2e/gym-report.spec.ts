...
test.describe.skip("Gym Report Flow", () => {
  test("User can submit a report and Admin can approve it", async ({
    page,
  }) => {
    ...
    await page
      .getByPlaceholder("현재 표시된 정보를 입력해주세요")
      .fill("10:00-22:00");
    await page
      .getByPlaceholder("올바른 정보를 입력해주세요")
      .fill("09:00-23:00");
